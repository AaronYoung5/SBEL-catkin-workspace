...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
ChronoRosPathFollowerLauncher::ChronoRosPathFollowerLauncher()
    : m_target_speed(12.0), m_path_file("paths/ISO_double_lane_change.txt") {
...
//
// -----------------------------------------------------------------------------
void ChronoRosPathFollowerLauncher::InitVehicle() {
  // Contact method
...
//
// -----------------------------------------------------------------------------
void ChronoRosPathFollowerLauncher::InitTerrain() {
  // Rigid terrain
...
//
// -----------------------------------------------------------------------------
void ChronoRosPathFollowerLauncher::InitIrrlicht() {
...
//
// -----------------------------------------------------------------------------
void ChronoRosPathFollowerLauncher::InitDriver() {

  // From data file
  auto path = ChBezierCurve::read(GetDataFile(m_path_file));

  // Create the interactive driver system
  // m_driver = new ChRosPathFollowerDriver(m_veh.GetVehicle(), path, "my_path",
  //                                        m_target_speed, false);
  m_driver = new ChRosPathFollowerDriver();

  // m_driver->GetSteeringController().SetLookAheadDistance(5);
...
//
// -----------------------------------------------------------------------------
void ChronoRosPathFollowerLauncher::ChronoRun() {
...
//
// -----------------------------------------------------------------------------
void ChronoRosPathFollowerLauncher::Advance(double step) {
...
//
// -----------------------------------------------------------------------------
void ChronoRosPathFollowerLauncher::ChronoLoop() {
