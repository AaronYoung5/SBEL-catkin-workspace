...
(cl:defmethod cl:initialize-instance :after ((m <path_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'path_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rviz_visualizer-msg:<path_msg> is deprecated: use rviz_visualizer-msg:path_msg instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <path_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_visualizer-msg:points-val is deprecated.  Use rviz_visualizer-msg:points instead.")
  (points m))
