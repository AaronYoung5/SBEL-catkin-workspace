...
(cl:in-package chrono_launch-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chrono_launch-msg:<Num> is deprecated: use chrono_launch-msg:Num instead.")))
