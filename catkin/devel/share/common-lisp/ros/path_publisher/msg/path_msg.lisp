...
(cl:defmethod cl:initialize-instance :after ((m <path_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'path_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name path_publisher-msg:<path_msg> is deprecated: use path_publisher-msg:path_msg instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <path_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_publisher-msg:points-val is deprecated.  Use path_publisher-msg:points instead.")
  (points m))
