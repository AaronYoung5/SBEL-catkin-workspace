...
message(STATUS "path_follower: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ipath_follower:/home/aaron/ROS/catkin/src/path_follower/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/aaron/ROS/catkin/src/path_follower/msg/path_msg.msg" NAME_WE)
add_custom_target(_path_follower_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "path_follower" "/home/aaron/ROS/catkin/src/path_follower/msg/path_msg.msg" "geometry_msgs/Point"
)
...
_generate_msg_cpp(path_follower
  "/home/aaron/ROS/catkin/src/path_follower/msg/path_msg.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/path_follower)
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/path_follower/.+/__init__.pyc?$"
  )
endif()
